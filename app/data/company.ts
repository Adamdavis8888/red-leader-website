...
export const companyInfo: CompanyInfo = {
  story: [
    ...
    "As enterprises race to deploy AI systems, we've expanded our expertise to cover the new frontier: LLM infrastructure, AI security, and GPU-scale operations. From hardening model serving pipelines against prompt injection to orchestrating GPU clusters for production inference, we bring the same emergency-response rigor to AI infrastructure that we've always brought to traditional systems."
  ],
...
export const milestones: Milestone[] = [
  ...
  {
    year: 2025,
    title: "First Fortune 10 Client",
    description: "Became fully embedded for all Database optimization and Highly Available environments."
  },
  {
    year: 2026,
    title: "MindSource Integration",
    description: "Integrated into MindSource Inc as key Emergency Response partner for all clients in Silicon Valley."
  }
]
